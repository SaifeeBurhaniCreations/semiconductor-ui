...
import { 
    ...
    Play, Pause, Download, Aperture, Maximize2
} from 'lucide-react';
import { 
            ...
            <div className="flex-1 overflow-y-auto p-6 custom-scrollbar bg-quantum-950/50">
                ...
                {activeTab === 'aoi' && (
                    <div className="flex flex-col lg:flex-row gap-6 h-[600px] animate-in fade-in slide-in-from-bottom-2 duration-300">
                        {/* Main Viewer */}
                        <div className="flex-1 bg-black rounded-lg border border-quantum-600 relative overflow-hidden flex items-center justify-center group shadow-2xl flex-col">
                            ...
                            <div className="absolute top-0 left-0 right-0 p-4 bg-gradient-to-b from-black/80 to-transparent z-20 flex justify-between items-start pointer-events-none">
                                ...
                                <div className="pointer-events-auto flex space-x-2">
                                    <button 
                                        ...
                                        className="p-1.5 bg-quantum-900/80 hover:bg-quantum-800 border border-quantum-700 rounded text-slate-300"
                                    >
                                        {streamStatus === 'live' ? <Pause className="w-4 h-4" /> : <Play className="w-4 h-4" />}
                                    </button>
                                    <button className="p-1.5 bg-quantum-900/80 hover:bg-quantum-800 border border-quantum-700 rounded text-slate-300">
                        ...
                        <div className="w-80 bg-quantum-900 border border-quantum-600 rounded-lg flex flex-col shadow-lg">
                                    ...
                                    <div key={d.id} className="p-3 bg-quantum-950 border border-quantum-700 rounded hover:border-cyan-500/50 transition-colors cursor-pointer group">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex space-x-1 opacity-50 group-hover:opacity-100 transition-opacity">
                                                <button className="p-1 hover:text-green-400 hover:bg-green-900/20 rounded"><Check className="w-3 h-3" /></button>
                                                <button className="p-1 hover:text-red-400 hover:bg-red-900/20 rounded"><X className="w-3 h-3" /></button>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                            ...
                            <div className="p-4 border-t border-quantum-600 bg-quantum-950 rounded-b-lg">
                                <button className="w-full py-2 bg-cyan-600 hover:bg-cyan-500 text-white font-bold text-xs rounded transition-colors shadow-glow-cyan">
